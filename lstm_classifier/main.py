...
def main(args):
    ...
    for epoch in range(10):
        ...
        print(
            'Epoch: {epoch+1:02}, Train Loss: {train_loss:.3f}, Train Acc: {train_acc:.2f}%, Val. Loss: {val_loss:3f}, Val. Acc: {val_acc:.2f}%' % (
    ...
    print('Test Loss: {test_loss:.3f}, Test Acc: {test_acc:.2f}%' % (test_loss, test_acc))
